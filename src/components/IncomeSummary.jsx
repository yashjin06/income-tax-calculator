         ...
         <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '2.5rem', color: 'var(--text-main)' }}>
            <tbody>
               ...
               <tr style={{ background: 'var(--row-highlight-bg)' }}>
                  <td style={{ padding: '1rem', fontWeight: 'bold', fontSize: '1.25rem', textTransform: 'uppercase', color: 'var(--primary)', WebkitTextFillColor: 'var(--primary)' }}>Gross Total Income</td>
